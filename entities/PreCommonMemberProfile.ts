...
@Entity('pre_common_member_profile')
export class PreCommonMemberProfile {
  ...
  @Column('varchar', { name: 'birthcountry', length: 255 })
  birthcountry: string;
  ...
  @Column('varchar', { name: 'residecountry', length: 255 })
